...
echo "  / \   / \   / \   / \   / \   / \   / \   / \ "
echo " ( C ) ( B ) ( E ) ( S ) ( D ) ( D ) ( O ) ( S )"
echo "  \_/   \_/   \_/   \_/   \_/   \_/   \_/   \_/ "
echo "              CODED:BY MANZXPLOIT               "
echo "________________________________________________"
echo -e $lightgreen
echo "|manzxpluit |C.B.E.S |Hacker abal abal |Brebes love 🥵 |"
echo ""
echo -e $cyan
...
#build a menu for the recon modules using bash select
	...
	select reconopt in "${manzmenu[@]}"; do
...
then
	echo "Creating stunnel client on $LHOST:$LPORT"
		...
		sudo echo "[PENTEMENU-CLIENT]" >> /etc/stunnel/pentmenu.conf
...
echo "|         ROOTMANZXPLOIT TOOLS DDOS           |"
echo "|         TOOLSBY : MANZXPLOIT C.B.E.S        |"
echo "|         EDITOR : C.B.E.S                    |"
echo "|         VERSION : BARU BARU INI 😂🖕        |"
echo "|         TIKTOK : @e5a.cyber                 |"
echo "|AKU BERJANJI KETIKA AKU PUTUS DENGAN MU AKU  |" 
echo "| TIDAK AKAN BERPACARAN LAGI LOVE MANZXPLOIT  |"
echo "|AKU SAYANG KAMU WALAPUN KITA GAK ADA HUBUNGAN|"
echo "|   SALAM PERSAHABATAN DALAM SATU APLIKASI    |"
